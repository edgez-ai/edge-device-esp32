...
static const edgez_platform_api_t s_edgez_platform_api = {
    ...
    .halow_lookup_route = halow_interface_app_lookup_batman_route,
    .halow_get_routes = halow_interface_app_get_batman_routes,
    .halow_select_direct_peer = halow_interface_app_select_batman_direct_peer,
    .halow_note_foreground_traffic = halow_interface_app_note_foreground_traffic,
    .halow_foreground_traffic_active = halow_interface_app_foreground_traffic_active,
